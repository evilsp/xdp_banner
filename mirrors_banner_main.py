...
#        ipv6_last_access_time.labels(ip=in6_addr_to_ipv6(ip)).set(info.access_times)
#        ipv6_banned_timestamp.labels(ip=in6_addr_to_ipv6(ip)).set(
#            (current_time - datetime.timedelta(seconds=(1e9 - info.timestamp) / 1e9)).timestamp())
